...
import {
    deletePostFirebase, addPostFirebase,
    updatePostFirebase, getPostsUIDFirebase
} from '../../servicos/PostsService';
    ...
    const acaoCadastrar = async e => {
        ...
        if (editar) {
            try {
                ...
                setAlerta({
                    status: "error", message: "Erro ao atualizar o POST:"
                        + err
                });
            }
        } else { // novo
            try {
                ...
                setAlerta({
                    status: "error", message: "Erro ao criar o POST:" +
                        err
                });
            }
        }
